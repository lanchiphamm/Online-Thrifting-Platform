...
- As a user, I want to be able to view another person's profile and their products (optional)
- As a user, I want to be able to buy an item or get connected to the seller of this item (optional)
